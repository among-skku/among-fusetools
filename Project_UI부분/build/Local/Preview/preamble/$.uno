...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("115.145.246.225"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.56.1"), 12124)}, "D:\\KWONCESC\\Univ\\CapstoneDesign\\FUSE개발\\exploring\\exploring.unoproj", GetBundle, new string[] { })
{
...
{
return Uno.IO.Bundle.Get("exploring");
}
}
}
